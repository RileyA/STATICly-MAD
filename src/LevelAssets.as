package {
	...
	public class LevelAssets {
		...
		[Embed(source="../media/levels/Stack.json",  mimeType=
			"application/octet-stream")] private static const stack_lvl:Class;
		[Embed(source="../media/levels/Stuck.json",  mimeType=
			"application/octet-stream")] private static const stuck_lvl:Class;
		...
		*/
		private static var associativeArray:Object;
		{
			...
			associativeArray["stack"] = stack_lvl;
			associativeArray["stuck"] = stuck_lvl;
